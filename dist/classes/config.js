    ...
    value: function build(node) {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          var filePath = "".concat(this.directory, "/").concat(node, "/").concat(file.name);

          if (!_fs["default"].existsSync(filePath)) {
            (0, _utility.createDirectoryRecur)("".concat(this.directory, "/").concat((0, _utility.upperCaseFirst)(node)));
          }
          ...
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              ...
              if (this.isLocalModule(import_)) {
                var splitName = import_.split("/");
                mod.name = (0, _utility.upperCaseFirst)(splitName[splitName.length - 1]);
                mod.path = import_;
              } else {
                mod.name = (0, _utility.upperCaseFirst)(import_);
                mod.path = import_;
              }

              console.log("Checking filePath" + filePath);
              (0, _utility.writeImport)(filePath, mod);
            }
          } catch (err) {
            _iterator2.e(err);
          } finally {
          ...
          (0, _utility.writeContent)(filePath, (0, _utility.upperCaseFirst)(node));
          (0, _utility.writeExport)(filePath, (0, _utility.upperCaseFirst)(node));
        }
      } catch (err) {
        _iterator.e(err);
      } finally {
